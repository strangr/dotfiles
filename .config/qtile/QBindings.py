...
class QKeys:
    ...
    #TODO pass modifier from outside world
    def init_keys(self, mod, terminal):
        return [
            ...
            # Screenshots
            Key([], "Print", lazy.spawn("scrot " + self.homeDir + "/Pictures/screens/'%Y-%m-%d-%H-%M-%s'.png"), desc="Screenshot"),
            Key(["shift"], "Print", lazy.spawn("scrot -s " + self.homeDir + "/Pictures/screens/'%Y-%m-%d-%H-%M-%s'.png"), desc="Screenshot Rectangle"),
